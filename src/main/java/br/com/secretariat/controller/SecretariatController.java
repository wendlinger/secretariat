...
import br.com.secretariat.exceptions.ResourceNotFoundException;
...
public class SecretariatController {
	...
	public ResponseEntity<Secretariat> changeUnderInvestigation(@PathVariable Long id)
			throws ResourceNotFoundException {
		if (!(secretariatService.secretariatExistById(id))) {
			throw new ResourceNotFoundException("Secretariat not found on: " + id);
		}
		return ResponseEntity.ok(secretariatService.changeUnderInvestigation(id));
	}
}
